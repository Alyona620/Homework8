		    ...
		    <td width="50%" valign="top" align="center">
			    <table width="100%" class="rsproduct">
			      ...
			      <br /><br /></div>
			         ...
			         <tr class="thisform">
			            <td width="120" bgcolor="#FFFFFF"><?php echo JText::_('RSFP_VERSION');?></td>
			            <td bgcolor="#FFFFFF"><?php echo _RSFORM_VERSION;?></td>
			         </tr>
			         <tr class="thisform">
			            <td bgcolor="#FFFFFF"><?php echo JText::_('RSFP_COPYRIGHT'); ?></td>
			            <td bgcolor="#FFFFFF"><?php echo _RSFORM_COPYRIGHT;?></td>
			         </tr>
			         <tr class="thisform">
			            <td bgcolor="#FFFFFF"><?php echo JText::_('RSFP_LICENSE'); ?></td>
			            <td bgcolor="#FFFFFF"><?php echo _RSFORM_LICENSE;?></td>
			         </tr>
			         <tr class="thisform">
			            <td valign="top" bgcolor="#FFFFFF"><?php echo JText::_('RSFP_AUTHOR');?></td>
			            <td bgcolor="#FFFFFF">
