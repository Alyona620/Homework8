	...
	<td valign="top" align="left">
		...
		<table style="width: 100%;">
			...
			<tr>
				...
				<tr>
					<td>
						<input name="UserEmailAttachFile" class="rs_inp rs_80" id="UserEmailAttachFile" value="<?php echo !empty($this->form->UserEmailAttachFile) ? $this->form->UserEmailAttachFile : JPATH_SITE.DS.'components'.DS.'com_rsform'.DS.'uploads'; ?>" <?php if (!$this->form->UserEmailAttach) { ?>disabled="disabled"<?php } ?> />
					</td>
