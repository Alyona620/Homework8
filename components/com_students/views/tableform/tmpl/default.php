...
<div class="table-edit front-end-edit">
    ...
    <form id="form-table" action="<?php echo JRoute::_('index.php?option=com_students&task=table.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
            				<li><?php echo $this->form->getLabel('id'); ?>
				<?php echo $this->form->getInput('id'); ?></li>
				<?php $canState = false; ?>
				<?php if($this->item->id): ?>
					<?php $canState = $canState = JFactory::getUser()->authorise('core.edit.state','com_students.table'); ?>
				<?php else: ?>
					<?php $canState = JFactory::getUser()->authorise('core.edit.state','com_students.table.'.$this->item->id); ?>
				...
				<div class="width-100 fltlft" <?php if (!JFactory::getUser()->authorise('core.admin','students')): ?> style="display:none;" <?php endif; ?> >
                ...
                <script type="text/javascript">
                    ...
                    jQuery('#rules select').each(function(){
                       ...
                       console.log(input);
                       document.getElementById("form-table").appendChild(input);
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_students&task=table.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_students" />
            <input type="hidden" name="task" value="tableform.save" />
