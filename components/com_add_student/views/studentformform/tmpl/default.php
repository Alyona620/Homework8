...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-studentform').submit(function(event){
...
<div class="studentform-edit front-end-edit">
    ...
    <form id="form-studentform" action="<?php echo JRoute::_('index.php?option=com_add_student&task=studentform.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>

				<?php $canState = false; ?>
				<?php if($this->item->id): ?>
					<?php $canState = $canState = JFactory::getUser()->authorise('core.edit.state','com_add_student.studentform'); ?>
				<?php else: ?>
					<?php $canState = JFactory::getUser()->authorise('core.edit.state','com_add_student.studentform.'.$this->item->id); ?>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_add_student&task=studentform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_add_student" />
            <input type="hidden" name="task" value="studentformform.save" />
